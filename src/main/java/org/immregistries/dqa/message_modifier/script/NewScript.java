...
package org.immregistries.dqa.message_modifier.script;/** New line translator. */
public class NewScript/*@bgen(jjtree)*/implements NewScriptTreeConstants, NewScriptConstants {/*@bgen(jjtree)*/
  protected static JJTNewScriptState jjtree = new JJTNewScriptState();public static class CustomNode extends SimpleNode {
    CustomNode(int i){
      super(i);
    }
...
if (jjtc000) {
  ...
  public NewScript(CharStream stream) {
    ...
    token_source = new NewScriptTokenManager(stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
